  ...
  >
    <div class="flex justify-between items-center">
      ...
      <div class="flex items-center space-x-4">
        ...
        <NuxtLink
          to="/auth"
          class="px-6 py-2.5 font-medium text-white hover:text-primary transition-colors duration-200 flex items-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-gray rounded"
        ...
        <button
          type="button"
          class="p-2.5 text-white rounded-full hover:bg-white/10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-gray"
        ...
        <button
          type="button"
          class="relative p-2.5 text-white rounded-full hover:bg-white/10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-gray"
