        ...
        <div class="container">
          <div class="flex flex-wrap justify-between">
            <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0 space-y-4">
              <h3 class="text-2xl font-bold text-primary font-antonio uppercase">online learning platform</h3>
              <p class="text-gray-400">
                Empowering learners worldwide with quality education and innovative learning
                solutions.
              </p>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
              ...
              <ul class="space-y-3">
                ...
                <li>
                  <a href="#" class="text-gray-400 hover:text-primary transition-colors">Courses</a>
                </li>
                <li>
                  <a href="#" class="text-gray-400 hover:text-primary transition-colors">About Us</a>
                </li>
                <li>
                  <a href="#" class="text-gray-400 hover:text-primary transition-colors"
                    >Instructors</a
                ...
                <li>
                  <a href="#" class="text-gray-400 hover:text-primary transition-colors">Blog</a>
                </li>
                <li>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 lg:mb-0">
              ...
              <ul class="space-y-4 text-gray-400">
                ...
                <li class="flex items-center">
                  <svg
                    class="h-5 w-5 text-primary mr-3 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
