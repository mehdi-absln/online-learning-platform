  ...
  const courseData = [
    {
      ...
      slug: 'nextjs-15-full-stack-development',
      description: 'Build modern full-stack apps with Next.js 15: App Router, Server Components, server actions, and edge-ready deployments.',
      shortDescription: 'Master the Next.js App Router and build production-ready apps.',
      price: 54.99,
      originalPrice: 109.99,
      thumbnail: 'https://images.unsplash.com/photo-1667372393116-3963dc47a2c0?w=800',
      ...
      isFeatured: true,
      isPublished: true,
      tags: 'nextjs,react,fullstack,ssr,typescript',
      createdAt: now,
      updatedAt: now,
    },
    {
  ...
  if (firstCourse) {
    const [section1] = await db
      ...
      .values({
        ...
        description: 'Introduction to Next.js 15 and project setup',
        orderVal: 0,
        createdAt: now,
        updatedAt: now,
      })
      ...
      const lessonData = [
        {
          ...
          description: 'What is Next.js 15 and why use it?',
        ...
        },
        {
          ...
          title: 'Project Setup',
          slug: 'project-setup',
          description: 'Setting up your first Next.js project',
          content: 'Let\'s create a new Next.js project...',
          duration: '22:15',
          orderVal: 1,
          isFree: true,
          createdAt: now,
    ...
    const objectives = [
      'Build full-stack applications with Next.js 15',
      'Master the App Router and Server Components',
      'Implement server actions and data fetching',
