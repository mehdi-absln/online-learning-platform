...
export const courseLearningObjectives = sqliteTable('course_learning_objectives', {
  ...
  order: integer('order').notNull(), // Order of the objective in the list
  createdAt: integer('created_at', { mode: 'timestamp' }).notNull(),
  updatedAt: integer('updated_at', { mode: 'timestamp' }).notNull(),
})
...
export const courseContentSections = sqliteTable('course_content_sections', {
  ...
  duration: text('duration').notNull(), // Duration of the section (e.g., '2 hours')
  order: integer('order').notNull(), // Order of the section in the course
  createdAt: integer('created_at', { mode: 'timestamp' }).notNull(),
  updatedAt: integer('updated_at', { mode: 'timestamp' }).notNull(),
})
